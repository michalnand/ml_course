...
layer8 : global average pooling, size 7x7

layer9 : 10 output neurons

learning rate = 0.004
accuracy afeter 1 epoch = 96.82%
'''

cnn = CNN(dataset.get_input_shape(), dataset.get_output_shape(), 0.004)
